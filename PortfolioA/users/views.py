...
def signup(request):
    ...
    # GET 요청 시, 빈 form을 생성한다.
        ...
        form = SignupForm()
    context = {"form": form}
    return render(request, "PortfolioA/users/signup.html", context)
...
def profile(request, user_id):
    ...
    return render(request, "PortfolioA/users/profile.html", context)
...
def followers(request, user_id):
    ...
    return render(request, "PortfolioA/users/followers.html", context)
...
def following(request, user_id):
    ...
    return render(request, "PortfolioA/users/following.html", context)
