...
def feeds(request):
    ...
    return render(request, "PortfolioA/posts/feeds.html", context)
...
def post_add(request):
    ...
    context = {"form": form}
    return render(request, "PortfolioA/posts/post_add.html", context)
...
def tags(request, tag_name):
    ...
    return render(request, 'PortfolioA/posts/tags.html', context)
...
def post_detail(request, post_id):
    ...
    return render(request, "PortfolioA/posts/post_detail.html", context)
